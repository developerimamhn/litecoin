        ...
        <div id="hero" className='relative'>
          ...
          <div className='relative z-2'>
            <div className='container mx-auto px-[24px] sm:px-0 w-full relative flex items-center justify-center flex-col'>
                <div  className='flex items-center justify-center flex-col pt-[70px] sm:pt-[70px] md:pt-[90px] lg:pt-[120px] xl:pt-[130px] 2xl:pt-[12%] '>
                  ...
                  <Image ref={imgRef} className='mx-auto w-[80%] mt-auto z-10 pt-[24px] sm:pt-[32px] md:pt-[36px] lg:pt-[40px] xl:pt-[48px] 2xl:pt-[64px]' src={pageone} alt=''/>
                </div>
