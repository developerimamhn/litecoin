...
const cardsData = [
  {
    ...
    version: "Litecoin Core 0.21.4 for Windows",
    image: dow,
  ...
  },
  {
    ...
    version: "Litecoin Core 0.21.4 for Mac OS",
    image: dowMac,
    buttons: ["GPG Signatures"]
  },
  {
    ...
    version: "Litecoin Core 0.21.4 for Linux",
    image: dowLinux,
    buttons: [
      "GPG Signatures",
      "aarch64",
  ...
  {
    id: 4,
    title: "Download for Nexus Wallet",
    version: "Nexus Wallet for Android",
    image: dowUbuntu,
    buttons: ["GPG Signatures"]
  },
  {
    id: 5,
    title: "Download for Electrum",
    version: "Electrum Litecoin",
    image: dowFedora,
    buttons: ["GPG Signatures"]
  },
  {
      ...
      id="howitworks" className=" relative   pb-[40px] sm:pb-[40px] md:pb-[48px] lg:pb-[64px] xl:pb-[100px] 2xl:!pb-[130px]">
        ...
        <div className=''>
          <div className='flex items-center justify-center relative py-[36px] sm:py-[40px] md:py-[48px] lg:py-[64px] xl:py-[96px] 2xl:py-[128px]'>
            ...
            <button className='buttonauditeltsss relative z-10 cursor-pointer text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] 2xl:text-[16px] flex items-center py-[7px] sm:py-[8px] md:py-[6px] pr-[10px] sm:pr-[11px] md:pr-[12px] lg:pr-[13px] xl:pr-[14px] 2xl:pr-[15px] group gap-[7.50px] pl-[7px] sm:pl-[8px] md:pl-[6px]'>
                <div
                    class="absolute left-1/2 -translate-x-1/2 -top-px block h-px w-[80%]  animate-gradient bg-linear-to-r from-[#4f1ad600]  via-[#4F1AD6] bg-size-[var(--bg-size)_100%] rounded-[inherit] [mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] p-[1px] mask-subtract!"
                ></div>
